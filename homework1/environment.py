...
if __name__ == "__main__":
    ...
    mazes = [
        ...
        # Medium difficulty: Score > -30 CHECK
        ["XXXXXXXXX",
         "X..PGP..X",
         "X.......X",
         "X..P.P..X",
        ...
        # Extra-hard difficulty: Score > -35
        ["XXXXXXXXX",
         "XP..GPPPX",
         "XP.P.PPPX",
         "XP.PPPPPX",
    ...
    env = Environment(mazes[18]) # Call with tick_length = 0 for instant games
    env.start_mission()
